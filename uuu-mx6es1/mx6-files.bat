...
set cp_cmd=copy /y
set cp_dst=files
set cp_src=Y:\work\mx6\mx6-41498
...
%cp_cmd% Y:\work\imx-yocto-bsp\build-xwayland\tmp\deploy\images\imx6qsabreauto\fsl-image-mfgtool-initramfs-imx6qsabreauto.cpio.gz.u-boot %cp_dst%\initramfs-mfg.cpio.gz.u-boot
